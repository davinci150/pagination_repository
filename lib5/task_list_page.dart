    ...
    return StreamBuilder<TaskListData>(
        ...
        builder: (context, snapshot) {
          return Scaffold(
            appBar: AppBar(
              title: Text(
                '${widget.filter.runtimeType} | length: ${snapshot.data?.tasks.length} | total: ${snapshot.data?.total} | hasMore: ${snapshot.data?.total == null || snapshot.data!.total! > snapshot.data!.tasks.length}',
