...
class TasksCache {
  ...
  Future<List<TaskModel>> fetch({
    ...
    print('[TasksCache] fetch $groupKey $offset $limit');
  ...
  Future<void> updateTotalFromPageIfFrontier({
    ...
    print('[TasksCache] updateTotalFromPageIfFrontier $filter $pageOffset $requested $received');
  ...
  Future<void> upsertTasks({
    ...
    print('[TasksCache] upsertTasks $groupKey $from ${tasks.length}');
    final idx =
  ...
  Future<void> deleteGroup(Filter groupKey) async {
    print('[TasksCache] deleteGroup $groupKey');
    _indexByGroup.remove(groupKey);
  }

  Future<void> deleteEntity(int id) async {
    print('[TasksCache] deleteEntity $id');
  ...
  Future<void> updateEntity(TaskModel task) async {
    print('[TasksCache] updateEntity $task');
